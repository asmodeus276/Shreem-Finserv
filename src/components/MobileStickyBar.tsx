    ...
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-slate-200 py-2.5 px-3 shadow-[0_-4px_20px_rgba(0,0,0,0.08)]">
      <div className="grid grid-cols-4 gap-1.5 max-w-md mx-auto">
        ...
        <Link
          ...
          className="flex flex-col items-center justify-center p-1.5 rounded-xl bg-[#E30613] hover:bg-[#FF1A27] text-white active:scale-95 transition-all text-center shadow-sm"
        >
