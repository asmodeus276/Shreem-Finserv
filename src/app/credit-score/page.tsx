...
export default function CreditScorePage() {
  const faqs = [
    ...
    },
    {
      ...
      a: "Yes! Shreem Finserv partners with over 50+ banks and NBFCs, including specialized lending institutions that offer Loan Against Property (LAP), machinery loans, car loans, or co-applicant backed credit for borrowers on a credit-builder track.",
    },
  ];
    ...
    <div className="pt-24 sm:pt-28 md:pt-32 pb-16 bg-slate-50 min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 py-16">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <span className="text-xs font-extrabold uppercase tracking-wider text-[#0B309A] bg-blue-100/60 px-3 py-1 rounded-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-6 rounded-3xl border border-blue-200/80 shadow-xs hover:shadow-md transition-all">
            <div className="w-14 h-14 bg-blue-100 text-[#0B309A] rounded-2xl flex items-center justify-center font-black text-lg mb-4">
              700-774
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 text-center space-y-2">
              <div className="text-3xl font-black text-[#0B309A]">35%</div>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 text-center space-y-2">
              <div className="text-3xl font-black text-[#0B309A]">30%</div>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 text-center space-y-2">
              <div className="text-3xl font-black text-[#0B309A]">15%</div>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 text-center space-y-2">
              <div className="text-3xl font-black text-[#0B309A]">10%</div>
      ...
      <section className="max-w-4xl mx-auto px-4 md:px-8 py-16">
          ...
          {faqs.map((faq, i) => (
            <div key={i} className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-2">
              <h3 className="font-bold text-base text-slate-900 flex items-start gap-2.5">
                <span className="text-[#0B309A] font-extrabold">Q.</span>
                <span>{faq.q}</span>
              </h3>
        ...
        {/* CTA banner */}
        <div className="mt-12 bg-gradient-to-r from-[#00103A] via-[#0B309A] to-[#0B2E8D] p-8 rounded-3xl text-white text-center space-y-4 shadow-xl">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <Link
              href="/apply"
              className="bg-[#E30613] hover:bg-[#B8040E] text-white font-bold py-3 px-6 rounded-xl transition-all shadow-md text-sm"
            >
              Apply for Loan Now
            </Link>
            <a
