...
export const metadata: Metadata = {
  title: "Contact Us - Shreem Finserv Priority Helpline & Headquarters",
  description:
...
export default function ContactPage() {
  return (
    <div className="pt-24 sm:pt-28 md:pt-32 pb-20 bg-[#F7F9FB]">
      
      {/* Capital Need Style Banner */}
      <InnerBanner
        badge="24/7 DEDICATED SUPPORT DESK"
        badgeIcon="headset_mic"
        title="Connect With Our"
        highlightText="Financial Advisors"
        subtitle="Speak directly with our senior underwriting desk or visit our Delhi-NCR headquarters for fast, transparent loan assistance."
        breadcrumbs={[
          { label: "Home", href: "/" },
          { label: "Company" },
          { label: "Contact Us" },
        ...
        imageAlt="Shreem Finserv Financial Advisory Headquarters"
        ctaText="Call Priority Line"
        ctaLink={`tel:${BRAND_CONFIG.phone.replace(/\s+/g, "")}`}
        quickStats={[
          { label: "Phone Support", value: BRAND_CONFIG.phoneDisplay },
